        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              whileHover={
                isMobile ? {} : { y: -8, transition: { duration: 0.3 } }
              }
            >
              ...
              <div className="bg-black/80 rounded-xl sm:rounded-2xl p-3 mt-4 sm:mt-6 w-full max-w-[240px]">
            ...
            >
              ...
              >
                {[
                  ...
                  <span
                    key={service}
                    className="px-2.5 sm:px-3 py-1 sm:py-1.5 bg-white/20 backdrop-blur-sm rounded-full text-xs sm:text-sm font-medium hover:bg-white/30 transition-colors duration-200"
                  >
                    {service}
                  </span>
                ))}
            ...
            >
              <div className="my-auto flex flex-col justify-center items-center">
                <motion.div
                  className="w-16 h-16 sm:w-20 sm:h-20 mb-4 sm:mb-6 text-5xl"
