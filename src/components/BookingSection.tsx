          ...
          <div className="grid lg:grid-cols-2">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                >
                  <img
                    src="/src/assests/client/pranav.webp"
                    alt="pranav"
              ...
              <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
                Schedule a quick intro call to learn more about how Pixel2code
                works and how it can help you with your website needs.
              </p>
            </motion.div>
            ...
            >
              ...
              <Calendar
                ...
                classNames={{
                  ...
                  head_cell:
                    "text-muted-foreground rounded-md w-8 md:w-10 font-normal text-xs md:text-sm",
