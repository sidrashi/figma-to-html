          ...
          <div className="mx-6 sm:mx-10">
            ...
            <div className="relative z-2 flex flex-col lg:flex-row lg:items-stretch items-start justify-between gap-8">
              ...
              <div className="w-full rounded-2xl relative">
                <div
                  className="bg-black text-white rounded-2xl border border-[#0813ff] h-full hero-shadow bg-cover bg-top-left p-8 relative overflow-hidden"
                ...
                >
                  ...
                  <div className="mt-20 text-black">
                    <h1>Join</h1>
                    <h1>Designjoy</h1>
                    <p className="mt-4 text-base text-black font-normal">
                      One Subcription to rule them all
                    </p>
                    <a
                      href="#"
                      className="inline-block py-5 px-4 cursor-pointer text-black bg-white text-center w-full rounded-lg mt-6 text-xl font-medium animate-slide-up"
                    >
                      See pricing
                    </a>
                  </div>
